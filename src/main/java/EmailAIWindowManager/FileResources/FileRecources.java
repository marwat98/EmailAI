package EmailAIWindowManager.FileResources;

import EmailAIWindowManager.FileManagerClasses.FileManagerClass;
import EmailAIWindowManager.FileManagerClasses.FileManagerOpenAIClass;
...
public class FileRecources {
    ...
    public static final Path SEND_EMAIL_PATH = Paths.get(MAIN_PACKAGE_FILES, "sendEmailFile.txt");
    public static final Path SEARCH_POLE = Paths.get(MAIN_PACKAGE_FILES,"searchPoleDirection.txt");
    public static final Path POST_OFFICE_CHOOSE = Paths.get(MAIN_PACKAGE_FILES,"postOfficeChoose.txt");
    ...
    public final File postOffice = new File(String.valueOf(POST_OFFICE_CHOOSE));
    ...
    public final FileManagerClass description = new FileManagerClass(descriptionFile.toPath());
    public final FileManagerClass postOfficeChoose = new FileManagerClass(postOffice.toPath());
