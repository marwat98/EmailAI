...
public class SaveSettings implements SaveSettingsInterface {
    ...
    public void saveSettings(SettingsField settingsField, AlertClass alert) {
        ...
        boolean saveChoosePostOfficeOption = fileRecources.postOfficeOption.writeToFile(settingsField.getChoosePostOfficeOption());
        boolean saveHostAdress = fileRecources.hostAddressSave.writeToFile(settingsField.getCheckHostAddress());
